...
final class TabCoordinator: Coordinator {
    ...
    func start() {
        ...
        homeNav.tabBarItem.accessibilityLabel = "Trang chủ"
        ...
        historyNav.tabBarItem.accessibilityLabel = "Lịch sử xem"
        ...
        favoritesNav.tabBarItem.accessibilityLabel = "Phim yêu thích"
